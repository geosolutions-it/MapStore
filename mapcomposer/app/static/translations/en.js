...
GeoExt.Lang.add("en", {
    "gxp.plugins.SyntheticView.prototype": {
        ...
        extentLabel: "territorial",
        targetLabel: "typ of target",
        adrClassLabel: "Class ADR",
    ...
    "gxp.plugins.StandardProcessing.prototype": {
        ...
        targetSetLabel: "type target",
        accidentSetLabel : "type accident",
        adrLabel: "Class ADR",
        sostanzeLabel: "substances",
        accidentLabel: "accident",
        seriousnessLabel: "entities",
        resetButton: "Reset",
        cancelButton: "Cancel",
        ...
        allNotHumanTargetOption: "all environamental targets",
        entLieve: "mild",
        entGrave: "severe",
