...
GeoExt.Lang.add("en", {
    "gxp.plugins.SyntheticView.prototype": {
        ...
        elaborazioneLabel: "Tipo elaborazione EN",
        formulaLabel: "Formula EN",
        extentLabel: "Ambito territoriale EN",
        targetLabel: "Tipo bersaglio EN",
        adrClassLabel: "Classe ADR EN",
        substanceLabel: "Sostanze EN",
        accidentLabel: "Incidente EN",
        seriousnessLabel: "Entità EN",
        buffersLabel: "Raggi Aree Danno EN",
        fieldSetTitle: "Elaborazione EN",
        cancelButton: "Annulla Elaborazione EN",
        processButton: "Esegui Elaborazione EN",
        analyticViewButton: "Visualizzazione Analitica EN",
        weatherLabel: "Condizioni Meteo EN",  
        temporalLabel: "Condizioni Temporali EN",
        elabStandardLabel: "Elaborazione Standard EN",
        totalRiskLabel: "Rischio totale EN",
        defaultExtentLabel: "Regione Piemonte EN"
    },
    "gxp.plugins.StandardProcessing.prototype": {
        ...
        eastLabel:"Est EN",
        southLabel:"Sud EN",
        aoiFieldSetTitle: "Ambito Territoriale EN",
        setAoiText: "Seleziona Area EN",        
        setAoiTooltip: "Abilita la selezione della regione di interesse sulla mappa EN",
        notAvailableProcessing: "Tipo di elaborazione non ancora disponibile EN",
        targetLabel: "Bersaglio EN",
        macroTargetLabel: "Categoria EN",
        targetSetLabel: "Tipo bersaglio EN",
        accidentSetLabel : "Tipo Incidente EN",
        adrLabel: "Classe ADR EN",
        sostanzeLabel: "Sostanza EN",
        accidentLabel: "Incidente EN",
        seriousnessLabel: "Entità EN",
        resetButton: "Reimposta EN",
        cancelButton: "Annulla EN",
        viewMapButton: "Visualizza Mappa EN",
        formLabel: "Impostazioni di Elaborazione EN",
        bboxValidationTitle: "Selezione Area di Interesse EN",
        invalidAOI: "Le coordinate dell'area di interesse non sono valide. EN",
        bboxTooBig: "L'area selezionata e' troppo grande e il server potrebbe impiegare molto tempo a rispondere. Se si desidera continuare ugualmente premere OK. EN",
        weatherLabel: "Meteo EN",  
        temporalLabel: "Temporali EN",
        conditionsFielSetLabel: "Condizioni EN",   
        allClassOption: "Tutte le classi EN",
        allSostOption: "Tutte le sostanze EN",
        allScenOption: "Tutti gli incidenti EN",
        allEntOption: "Tutte le entità EN",
        allTargetOption: "Tutti i bersagli EN",
        allHumanTargetOption: "Tutti i Bersagli Umani EN",
        allNotHumanTargetOption: "Tutti i Bersagli Ambientali EN",
        entLieve: "Lieve EN",
        entGrave: "Grave EN",
        humanRiskLabel: "Rischio Sociale EN",
        notHumanRiskLabel: "Rischio Ambientale EN",
        lowRiskLabel: "Basso Rischio EN",
        mediumRiskLabel: "Medio Rischio EN",
        highRiskLabel: "Alto Rischio EN"
    },
