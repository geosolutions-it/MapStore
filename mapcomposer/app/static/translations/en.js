...
GeoExt.Lang.add("en", {
    ...
    "gxp.plugins.SyntheticView.prototype": {
        ...
        substanceLabel: "Hazard classes",
        accidentLabel: "accident",
        seriousnessLabel: "Entity",
        severenessLabel: "Severeness",
    ...
    "gxp.plugins.StandardProcessing.prototype": {
        ...
        sostanzeLabel: "Hazard classes",
        sostanzeSingoleLabel: "Single Substance",
        sostanzeSingoleWarningLabel: "Alert: the substance selection is used to select the corresponding hazard class for calculation purposes.",
        accidentLabel: "accident",
        seriousnessLabel: "Entity",
        resetButton: "Reset",
        cancelButton: "Cancel",
        ...
        notVisibleOnArcsMessage: "Formula not visible at this scale",
        notVisibleOnGridMessage: "Formula not visible at this scale",
        areaTooBigMessage: "Selected area is too large for this formula / resolution",
        resolutionNotAllowedMessage: "The selected resolution is not compatible with the territorial scope",
        resolutionLevel1: "Segment 100m",
        resolutionLevel2: "Segment 500m",
        resolutionLevel3: "Grid",
        resolutionLevel4: "Municipalities",
    ...
    "gxp.plugins.Routing.prototype": {
        menuText: "Calculate route",
        tooltip: "Calculate route",
        formulaText: "Formula",
        routeStartText: "Start",
        routeEndText: "Destination",
        descriptionText: "Description",
        routePointsText: "Route endpoints",
        selectPointText: "Select point from map",
        ...
        humanRiskFormula: "Less risky path for humans",
        notHumanRiskFormula: "Less risky path for the environment",
        humanVulnFormula: "Less vulnerable path for humans",    
        notHumanVulnFormula: "Less vulnerable path for the environment",    
        incFormula: "Path with less accidents probability",
