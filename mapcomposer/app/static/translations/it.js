...
GeoExt.Lang.add("it", {
    ...
    "gxp.widgets.form.ChangeMatrixPanel.prototype" :{
    	timeSelectionTitleText: "Selezione Temporale",
		soilSealingIndexTitleText: "Impermeabilizzazione del Suolo",
		clcLevelTitleText: "Livelli CLC",
		clcLegendBuilderTitleText: "Seleziona Livelli CLC",
    ...
    "gxp.widgets.form.SoilPanel.prototype" :{
		timeSelectionTitleText: "Selezione Temporale",
		soilSealingIndexTitleText: "Indice Impermeabilizzazione del Suolo",
		clcLevelTitleText: "Livelli CLC / Griglie Urbane",
		clcLegendBuilderTitleText: "Selezione Livelli CLC",
		roiTitleText: "Area d'Interesse",
		timeFilterTitle : 'Filtro Temporale',
		changeMatrixRasterFieldLabel : "Layer Raster",
		currentTimeFieldLabel: 'Tempo Corrente',
		...
		edgeDensityText: 'Densità al Bordo',
