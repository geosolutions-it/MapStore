...
GeoExt.Lang.add("it", {
    ...
    "gxp.widgets.form.ChangeMatrixPanel.prototype" :{
    	timeSelectionTitleText: "Filtro del Tempo",
		soilSealingIndexTitleText: "Consumo di Suolo",
		clcLevelTitleText: "Livelli di Uso/Copertura del Suolo",
		clcLegendBuilderTitleText: "Seleziona Classi di Uso/Copertura del Suolo",
    ...
    "gxp.widgets.form.SoilPanel.prototype" :{
		...
		consumeOnlyText: 'Consumo di Suolo',
		consumeOnlyConfText: 'Coeff. Approvvigionamento Alimentare',
		...
		radiusEmptyTextLabel: 'Raggio in metri (m)',
		bufferTextLabel: 'Buffer (m)',
		bufferEmptyTextLabel: 'Buffer in metri (m)',
