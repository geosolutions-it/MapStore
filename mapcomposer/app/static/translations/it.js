...
GeoExt.Lang.add("it", {
    ...
    "gxp.widgets.form.ChangeMatrixPanel.prototype" :{
		...
		soilSealingIndexTitleText: "Consumo di Suolo",
		clcLevelTitleText: "Livello di Copertura del Suolo",
		clcLegendBuilderTitleText: "Classi di Copertura del Suolo",
		roiTitleText: "Area di Interesse",
		timeFilterTitle : 'Filtro Temporale',
		changeMatrixRasterFieldLabel : "Layer Raster",
		currentTimeFieldLabel: 'Tempo Recente',
		referenceTimeFieldLabel: 'Tempo Remoto',
	...
	"gxp.plugins.ChangeMatrix.prototype" :{
		changeMatrixActionTip : "Crea una Matrice di Cambio per il layer raster",
		changeMatrixDialogTitle : "Matrice di Cambio",
		changeMatrixClassesFieldLabel : "Classi",
		changeMatrixRasterFieldLabel : "Layer Raster",
		changeMatrixCQLFilterT0FieldLabel : "Filtro Temporale (riferimento)",
		...
		changeMatrixResultsTitle : "Cambio Copertura del Suolo",
		...
		changeMatrixEmptyClassesDialogText : "Prego, selezionare almeno una classe",
		changeMatrixInvalidFormDialogTitle : "Errore",
		changeMatrixInvalidFormDialogText : "Tutti i campi sono obbligatori!",
		changeMatrixTimeoutDialogTitle : "Tempo Scaduto",
		changeMatrixTimeoutDialogText : "Tempo scaduto per la richiesta",
		changeMatrixResponseErrorDialogTitle : "Errore",
		changeMatrixResponseErrorDialogText : "Si è verificato un errore durante l'elaborazione della richiesta.",
		chgMatrixFieldSetTitle : 'Valori per la ChangeMatrix',
		scatterChartTabTitle : "Grafico Scatter",
    ...
    "gxp.widgets.form.SoilPanel.prototype" :{
		...
		submitButtonText: 'Invia',
		resetButtonText: 'Pulisci',
		imperviousnessText: 'Impermeabilizzazione',
		basedOnCLCText: 'Basati su Copertura di Suolo',
		...
		basedOnImperviousnessText: 'Basati su Impermeabilizzazione',
		urbanDispersionText: 'Sprawl Urbano',
		edgeDensityText: 'Densità dei Margini Urbani',
		urbanDiffusionText: 'Diffusione Urbana',
		urbanDiffusionAText: 'Incidenza Area Urbana',
		urbanDiffusionBText: 'Incidenza Poligono Urbano Maggiore',
		urbanDiffusionCText: 'Area Media Altri Poligoni Urbani',
		framesText: 'Frammentazione',
		consumeOnlyText: 'Perdita di Suolo',
		consumeOnlyConfText: 'Perdita Netta di Approvvigionamento Alimentare',
		urbanFabricClassesText: 'Modello di Sviluppo Urbano',
		newScenarioFragmentationText: 'Nuovo Scenario',
		newUrbanizationText: 'Nuova Urbanizzazione',
		newEcologicalCorridorText: 'Nuovo Corridoio Ecologico',
		radiusTextLabel: 'Raggio [m]',
		radiusEmptyTextLabel: 'valore in metri',
    ...
    "gxp.widgets.SoilSealingResume.prototype": {
        ...
        addLayerButtonText: "Aggiungi il layer '{0}'",
        basedOnCLCText: 'Basati su CLC',
        coverText: 'Coefficiente di Copertura',
        changingTaxText: 'Tasso di Variazione',
        marginConsumeText: 'Consumo Marginale del Suolo',
        sprawlText: 'Sprawl Urbano',
        basedOnImperviousnessText: 'Basati su Impermiabilizzazione',
        urbanDispersionText: 'Dispersione Urbana',
        edgeDensityText: 'Densità di Bordo',
        urbanDiffusionText: 'Diffusione Urbana',
        urbanDiffusionAText: 'Area Urbana',
        urbanDiffusionBText: 'Rapporto Poligono Maggiore',
        urbanDiffusionCText: 'Rapporto Altri Poligoni',
        framesText: 'Frammentazione',
