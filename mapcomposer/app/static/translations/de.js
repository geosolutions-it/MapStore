...
GeoExt.Lang.add("de", {
	...
	"gxp.plugins.SyntheticView.prototype": {
        viadottiGallerieWarning: "Achtung, die Bearbeitung enthält Straßenabschnitte mit Tunnels und/oder Viadukte/n ",
        title: "Übersicht",
        comuniText: "Gemeindevertretung",
        provinceText: "Landesvertretung",
        ...
        processButton: "Bearbeitung ausführen",
        loadButton: "Laden",
        saveButton: "Speichern",
        editProcessButton: "Bearbeiten",
        analyticViewButton: "Analyse",
        temporalLabel: "Wetterbedingungen",
        elabStandardLabel: "Standardbearbeitung",
        totalRiskLabel: "Gesamtrisiko",
        humanTitle:'Anthropologisches Risiko',    
        notHumanTitle:'Umweltrisiko',
        defaultExtentLabel: "Gesamtgebiet",
        
        wpsTitle: "Fehler",
        wpsError: "Fehler in der Anfrage des WPS-Services",
        loadMsg: "Laden...",
        notVisibleOnArcsMessage: "Berechnungsoptionen sind in diesem Maßstabsbereich nicht sichtbar",
        notVisibleOnGridMessage: "Berechnungsoptionen sind in diesem Maßstabsbereich nicht sichtbar",
        
        simMsg: 'Bearbeitung der Simulationsparameter in diesem Maßstabsbereich nicht möglich. Zoomen Sie in einen Maßstab kleiner als 1:17061',
        ...
        removeProcessingTooltip: 'Bearbeitung entfernen',
        removeProcessingMsgTitle: "Bearbeitung löschen",
        removeProcessingMsg: "Möchten Sie die Bearbeitung wirklich löschen? Die Aktion ist nicht wiederherstellbar!",
        loadProcessingButtonText: "Bearbeitung laden",
        selectProcessingMsgTitle: "Bearbeitung auswählen",
        selectProcessingMsg: "Sie müssen eine Bearbeitung auswählen",
        loadProcessingWinTitle: "Bearbeitung laden",
        
		saveDownloadMenuButton: "Export",  
        ...
        loadDownloadButton: "Export - Historisch",
    ...
    "gxp.plugins.StandardProcessing.prototype": {
        okButton: "Bestätige",
        viadottiGallerieButtonText: "Viadukte und Tunnels",
        viadottiGallerieArcIdHeader: "Straßenabschnitt",
        viadottiGallerieViadottoHeader: "Viadukt",
        viadottiGallerieGalleriaHeader: "Tunnel",
        title: "Bearbeitung",
        elaborazioneLabel: "Art der Bearbeitung",
        formulaLabel: "Formel",       
        resolutionLabel: "Auflösung",                        
        ...
        sostanzeSingoleLabel: "Einzelne Substanz",
        sostanzeSingoleWarningLabel: "Achtung: Die Selektion der Substanz dient der Auswahl der geeigneten Gefahrenklasse",
        accidentLabel: "Unfall",
        seriousnessLabel: "Intensität",
        resetButton: "Zurücksetzen",
        cancelButton: "Abbrechen",
        viewMapButton: "Starte Bearbeitung",
        ...
        areaTooBigMessage: "Gewählter Bereich ist zu groß für diese Formel/Auflösung",
        resolutionNotAllowedMessage: "Die gewählte Auflösung ist mit dem Bearbeitungsbereich nicht kompatibel",
        resolutionLevel1: "100m-Segment",
        resolutionLevel2: "500m-Segment",
        resolutionLevel3: "Raster",
        resolutionLevel4: "Ansicht Gemeindeebene",
        resolutionLevel5: "Ansicht Provinzebene",
        ...
        formulaHelpTitle: "Beschreibung der Formel"
    },
    "gxp.plugins.TabPanelWFSGrids.prototype": {
        displayMsgPaging: "Element {0} - {1} von {2}",
        emptyMsg: "Kein Element gefunden",
        noRecordFoundLabel: "Kein Element gefunden",
        loadMsg: "Laden...",
        refreshGridButton: "Aktualisiere alle Rasterdaten",
        targetsTextBotton: "vulnerable Elemente",
    ...
    "gxp.form.AOIFieldset.prototype":{
        ...
        aoiMethodLabel: "Modalität",
        aoiByRectLabel: "Rechteck",
        aoiByFeatureLabel: "Grenze selektieren",
        regioniLabel: "Regionen",
    ...
    "gxp.form.SelDamageArea.prototype":{
        ...
        comboScenarioSelection: "Wähle Substanz/Szenario",
		radius: "Radius"
    },
	...
	"gxp.widgets.form.BufferFieldset.prototype": {
        ...
        selectScenarioLabel: "Wähle Substanz / Szenario",
        uomLabel: "Meter"
	},
	...
	"gxp.plugins.GateTimeSliderTab.prototype":{
        ...
        helpTitle: 'Help',
        helpMsg: '<ul><li>gesamt: es die Gesamtzahl der im angegebenen Zeitraum erfasst Fahrzeuge darstellt</li><li>Durchschnittsgeschwindigkeit: ist , wie viele Fahrzeuge im Durchschnitt pro Stunde erkannt</li></ul>'
	},
    ...
    "gxp.plugins.ObuForm.prototype":{
        ...
        clearFieldTooltip: "Entleere das Feld"
    },
    ...
    "gxp.plugins.Routing.prototype": {
        ...
        routeEndText: "Ziel",
        descriptionText: "Beschreibung",
        routePointsText: "Maximalwerte der Route",
        selectPointText: "Selektiere Punkt in der Karte",
        calculateText: "Berechne",
        downloadText: "Export",
        socRiskText: "Anthrophologisch",
        envRiskText: "Umweltrelevant",
        lonText: "geogr. Länge",
        latText: "geogr. Breite",
        routingText: "Routing",
        blockRoadsText: "Straßen sperren",
        zoomToRoadsText: "Zoom zur Selektion",
        addRoadsText: "Zu sperrende Straßen hinzufügen",
        removeRoadsText: "Selektierte Straßen entfernen",
        resetRoadsText: "Alles entfernen",
        errorTitle: "Fehler",
        missingParametersMsg: "Art der Formel, Start und Ziel definieren",
        selectOneMsg: "Eine Option selektieren",
        fieldRequiredMsg: "Pflichtfeld",
        lengthFormula: "Kürzeste Route",
        humanRiskFormula: "Weniger riskante Route für den Menschen",
        notHumanRiskFormula: "Weniger riskante Route für die Umwelt",
        humanVulnFormula: "Route mit geringster Vulnerabilität für den Menschen",    
        notHumanVulnFormula: "Route mit geringster Vulnerabilität für die Umwelt",    
        incFormula: "Route mit geringster Unfallwahrscheinlichkeit",
        warningTitle: "Achtung",    
        warningText: "Das Fehlen einiger Informationen (Einbahnregelungen, Baustellen oder aktuelle Arbeiten und Fahrtgeschwindigkeit) lassen es nicht zu, die schnellste Route zu berechnen, sondern nur den streckenmäßig kürzesten Verlauf."
    }
});
