...
GeoExt.Lang.add("de", {
	"gxp.plugins.SyntheticView.prototype": {
        ...
        elaborazioneLabel: "Typ Verarbeitung",
        formulaLabel: "Formula",
        extentLabel: "Territoriale",
        targetLabel: "Typ Ziel",
        adrClassLabel: "Klasse ADR",
    ...
    "gxp.plugins.StandardProcessing.prototype": {
        ...
        targetSetLabel: "Art Ziel",
        accidentSetLabel : "Art Umfall",
        adrLabel: "Klasse ADR",
        ...
        allSostOption: "Alle Stoffe",
        allScenOption: "Alle Vorfälle",
        allEntOption: "Alle Entitäten",
        allTargetOption: "Alle Ziele",
        allHumanTargetOption: "Alle menschliche Ziele",
