...
GeoExt.Lang.add("fr", {
	...
	"gxp.plugins.DownloadPanel.prototype":{
        ...
        dselCRS: "Cible CRS",
        dselFormat: "Format",
        infoBtnTooltip: "Afficher les infos sur ce CRS",        
        ...
        msgTooltipFailed: "Manqué",
        msgTooltipAccepted: "Acceptée",        
        msgGeostoreException: "Exception GeoStore",  
		msgNone: "Aucun",		
        msgBox: "Box",
        msgPolygon: "Polygon",
        msgCircle: "Arrondissez",
        msgPlace: "Emplacement",        
        msgIntersection: "Intersection",
        msgClip: "Coupe",        
        msgInstance: "Instance",        
        msgName: "Nom",
        msgCreation: "Création",
		...
		executionIdFieldTooltipDelete: "Supprimer le champ ID d'exécution",		
