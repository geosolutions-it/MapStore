...
GeoExt.Lang.add("fr", {
	...
	"gxp.plugins.SyntheticView.prototype": {
        ...
        substanceLabel: "Les classes de danger",
    ...
    "gxp.plugins.StandardProcessing.prototype": {
        ...
        sostanzeLabel: "Les classes de danger",
        sostanzeSingoleLabel: "seule substance",
        sostanzeSingoleWarningLabel: "Alerte : la sélection de la substance est destinée à la recherche des fins de calcul classe de danger correspondants.",
        accidentLabel: "accident",
        seriousnessLabel: "Entité",
    ...
    "gxp.plugins.Routing.prototype": {
        ...
        lengthFormula: "Le plus court chemin",
        humanRiskFormula: "Chemin le moins risqué pour les humains",
        notHumanRiskFormula: "Chemin moins risqué pour l'environnement",
        humanVulnFormula: "Chemin moins vulnérables pour les humains",    
        notHumanVulnFormula: "Chemin moins vulnérables à l'environnement",    
        incFormula: "Chemin avec moins d'accidents probabilité",
        blockRoadsText: "Bloquer les routes",
        zoomToRoadsText: "Zoom sur la sélection",
        addRoadsText: "Ajouter routes pour bloquer",
        removeRoadsText: "Enlever la sélection",
        resetRoadsText: "Enlever tout"
    }
});
