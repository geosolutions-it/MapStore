...
var GeoExplorer = Ext.extend(gxp.Viewer, {
    ...
    addTemporalLayers: function(records){
		...
		// ////////////////////////////////////////////////////////////
		// Force the timeslider's internal 'increment check' to 1h if 
		// the range is too large (ie. for NDVI). This solve unespected 
		// bheavihors on thumbs initial setting.
		// ////////////////////////////////////////////////////////////
		timeManager.forceIncrement = timeStep == 16;
