{
   ...
   "gsSources":{                
		...
		"destination": {
			...
			"version":"1.1.1",
		    "url": "http://84.33.2.23/geoserver/destinationprod/ows",
			"layerBaseParams": {
				"TILED": true,
				"TILESORIGIN": "-180,-90"
            }
    ...
    },
    {
	   ...
	   }, 
	   {
			...
			"selectionLayerBaseURL": "http://84.33.2.23/geoserver/destinationprod/wms",
		...
		"targets": {
			"Popolazione residente": {				
				"featureType": "destinationprod:popolazione_residente",
				"columns": [
					{
						"header": "Residenti",      
						"dataIndex": "residenti"
				...
				"featureType": "destinationprod:popolazione_turistica",
				"fields": [
					{
						"name": "id",              
						"mapping": "id"
			...
			"Addetti industria e servizi": {
				"featureType": "destinationprod:industria_servizi",
				"fields": [
					{
						"name": "id",              
						"mapping": "id"
			...
			"Addetti/utenti strutture sanitarie": {
				"featureType": "destinationprod:strutture_sanitarie",
				"fields": [
					{
						"name": "id",              
						"mapping": "id"
			...
			"Addetti/utenti strutture scolastiche": {
				"featureType": "destinationprod:strutture_scolastiche",
				"fields": [
					{
						"name": "id",              
						"mapping": "id"
			...
			"Addetti/utenti centri commerciali": {
				"featureType": "destinationprod:centri_commerciali",
				"fields": [
					{
						"name": "id",              
						"mapping": "id"
			...
			"Zone urbanizzate": {
				"featureType": "destinationprod:zone_urbanizzate",
				"fields": [
					{
						"name": "id",              
						"mapping": "id"
			...
			"Aree boscate": {
				"featureType": "destinationprod:aree_boscate",
				"fields": [
					{
						"name": "id",              
						"mapping": "id"
			...
			"Aree protette": {
				"featureType": "destinationprod:aree_protette",
				"fields": [
					{
						"name": "id",              
						"mapping": "id"
			...
			"Aree agricole": {
				"featureType": "destinationprod:aree_agricole",
				"fields": [
					{
						"name": "id",              
						"mapping": "id"
			...
			"Acque superficiali": {
				"featureType": "destinationprod:acque_superficiali",
				"fields": [
					{
						"name": "id",              
						"mapping": "id"
			...
			"Acque sotterranee": {
				"featureType": "destinationprod:acque_sotterranee",
				"fields": [
					{
						"name": "id",              
						"mapping": "id"
			...
			"Beni culturali": {
				"featureType": "destinationprod:beni_culturali",
				"fields": [
					{
						"name": "id",              
						"mapping": "id"
