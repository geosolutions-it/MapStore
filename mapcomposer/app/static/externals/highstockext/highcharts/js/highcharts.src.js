 ...
 */
// JSLint options:
/*global Highcharts, document, window, navigator, setInterval, clearInterval, clearTimeout, setTimeout, location, jQuery, $, console */ (function () {
    ...
    Axis.prototype = {
        ...
        getTitlePosition: function () {
            ...
            return {
                x: horiz ? alongAxis : offAxis + (opposite ? this.width : 0) + offset +
    ...
    Chart.prototype = {
        ...
        init: function (userOptions, callback) {
            ...
            var optionsChart = options.chart,
                ...
                margin = isObject(optionsMargin) ?
                    optionsMargin : [optionsMargin, optionsMargin, optionsMargin, optionsMargin];
        ...
        getMargins: function () {
            ...
            if ((chart.title || chart.subtitle) && !defined(chart.optionsMarginTop)) {
                titleOffset = mathMax(
                (chart.title && !chartTitleOptions.floating && !chartTitleOptions.verticalAlign && chartTitleOptions.y) || 0, (chart.subtitle && !chartSubtitleOptions.floating && !chartSubtitleOptions.verticalAlign && chartSubtitleOptions.y) || 0);
                if (titleOffset) {
        ...
        alignDataLabel: function (point, dataLabel, options, alignTo, isNew) {
            ...
            dataLabel.attr({
                visibility: options.crop === false || chart.isInsidePlot(alignAttr.x, alignAttr.y) || chart.isInsidePlot(plotX, plotY, inverted) ?
                    (chart.renderer.isSVG ? 'inherit' : VISIBLE) : HIDDEN
            });
