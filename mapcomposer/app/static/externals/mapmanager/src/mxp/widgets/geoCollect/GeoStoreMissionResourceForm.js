 ...
 * 
 */
mxp.widgets.GeoStoreMissionResourceForm = Ext.extend(Ext.Panel, {

    /** api: xtype = mxp_geostore_mission_resource_form */
	...
	initComponent: function() {
        ...
        //Pannello da qui inizia la creazione del pannello con il json 
...
,/*{
	...
	ref:'/missionResEdit'
		...
		mxp.widgets.GeoStoreMissionResourceForm.superclass.initComponent.call(this, arguments);
	},
...
//this.resource.getResourceEditor().loadResourceData(this.missionResEdit.getResourceData());
...
Ext.reg(mxp.widgets.GeoStoreMissionResourceForm.prototype.xtype, mxp.widgets.GeoStoreMissionResourceForm);