...
/** api: constructor
 *  .. class:: GeostoreResourceEditor(config)
 *
 *    Open a plugin to interact with GeoStore for editing Resources of a category 
 *    
 */
mxp.plugins.GeostoreResourceEditor = Ext.extend(mxp.plugins.Tool, {
    ...
    addActions: function() {
        ...
        return mxp.plugins.GeostoreResourceEditor.superclass.addActions.apply(this, [actions]);
    },
    ...
    addOutput: function(config) {
        ...
        return mxp.plugins.GeostoreResourceEditor.superclass.addOutput.apply(this, arguments);
    }
    
});

Ext.preg(mxp.plugins.GeostoreResourceEditor.prototype.ptype, mxp.plugins.GeostoreResourceEditor);
