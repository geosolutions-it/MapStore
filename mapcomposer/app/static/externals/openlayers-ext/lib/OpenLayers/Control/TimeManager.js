...
OpenLayers.Control.TimeManager = OpenLayers.Class(OpenLayers.Control, {
	 ...
	 tick:function() {
        ...
        if(this.currentTime > this.range[1] || this.currentTime < this.range[0]) {
            ...
            if(this.canTickCheck()) {
                ...
                }, this), 1000 * (this.frameRate / 4)); //setta il tempo di attesa se il layer non si � ancora caricato prima di riaggiornare il tempo e fare una nuova MergeNewParameter
            }
        }
    },
    /**
    ...
    setRange:function(range) {
        ...
        //#######
        //commentato l'if per consentire il settaggio dei valori dello slide cambiando lo step e le unit� anche se i valore di range non sono cambiati
        //#######
    ...
    guessPlaybackRate:function(){
        ...
        if (timeSpans) {
            ...
            // Commentato perch� sovrascrive le impostazioni della configurazione
