...
gxp.form.AOIFieldset = Ext.extend(Ext.form.FieldSet,  {
    ...
    setType: function(type) {
        Ext.getCmp(this.id + '-aoimethod').setValue(this.id + '-' + type + 'check', true);
    },
    
    selectFeature: function(type, id) {
        if(type === 'comune') {
            this.comuni.setValue(id);
        }
        if(type === 'provincia') {
