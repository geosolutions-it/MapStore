 ...
 *
 */
gxp.plugins.printreport.AgrometChartGenerator = Ext.extend(gxp.plugins.printreport.Generator, {
    ...
    isReportCompleted: function(){
        if(this.chartsSVG.length > 0 && --this.agrometChartPanel.chartsToLoad == 0) 
            return true;
        else
            return false;
    },
