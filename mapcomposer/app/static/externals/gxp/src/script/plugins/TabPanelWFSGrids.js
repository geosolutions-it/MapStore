...
gxp.plugins.TabPanelWFSGrids = Ext.extend(gxp.plugins.Tool, {
    ...
    addOutput: function(config) {
                ...
                for(var gridName in panel) {
                    if(panel.hasOwnProperty(gridName)) {
                        ...
                        var wfsGridConf={
                            ...
                            "allowEdit": gridCfg.allowEdit || false,
                            "layerEditName": gridCfg.layerEditName || false,
                            "sourceEditSRS": gridCfg.sourceEditSRS || false
                        };
        ...
        var tabPanel = new Ext.TabPanel({
            ...
            loadGridsFromJson: function(attributeName, attributeValue, data, tplData, activeTab) {
                activeTab = activeTab || 0;
                this.removeAllGrids();
                var grids = this.hideAllBut(attributeName, attributeValue);
