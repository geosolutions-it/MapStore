...
/**
 * Configuration file for the Usid Service Contains database connection
 * parameters and maps DDL and DML documents
 * 
 * @author nali
 */
public class JDBCServiceConfig {
    ...
    public JDBCServiceConfig(JDBCServiceConfig other) {
        name = other.getName();
    ...
    /**
     * Flag controlling whether to connect through JNDI or through creation of a
     * direct connection.
     * <p>
    ...
    /**
     * Set flag controlling whether to connect through JNDI or through creation of a
     * direct connection.
     */
    ...
    /**
     * @param groupAdminRoleName the groupAdminRoleName to set
     */
    ...
    public void initBeforeSave() {
        if (propertyFileNameDDL == null) {
            propertyFileNameDDL = defaultDDLFilename();
        }
    
        if (propertyFileNameDML == null) {
            propertyFileNameDML = defaultDMLFilename();
        }
    }
    ...
    /**
     * The class name of the service to be constructed The class must have a
     * constructor with a string argument, specifying the name of the service
     * 
     * @param className
     */
