 ...
 */   
gxp.plugins.he.WMSRasterStylesDialogHE = {
    ...
    init: function(target) {
        Ext.apply(target, gxp.plugins.he.WMSRasterStylesDialogHE);
    },
    ...
    removeRule: function() {
        if (this.isRaster) {
            ...
            gxp.he.WMSStylesDialogHE.prototype.removeRule.apply(this, arguments);
        }
    },
    ...
    editRule: function() {
        this.isRaster ? this.editPseudoRule() :
            gxp.he.WMSStylesDialogHE.prototype.editRule.apply(this, arguments);
    },
...
/** api: ptype = gxp_wmsrasterstylesdialoghe */
Ext.preg("gxp_wmsrasterstylesdialoghe", gxp.plugins.he.WMSRasterStylesDialogHE);
