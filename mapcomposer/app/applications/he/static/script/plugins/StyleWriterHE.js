 ...
 *      ``layerRecord``.
 */
gxp.plugins.he.StyleWriterHE = Ext.extend(gxp.plugins.StyleWriter, {
    ...
    constructor: function(config) {
        ...
        gxp.plugins.he.StyleWriterHE.superclass.constructor.apply(this, arguments);
    },
        ...
        target.stylesStore.on({
            "remove": function(store, record, index) {
                ...
                record.get("name") === styleName &&
                    this.deletedStyles.push(record);
            },
            scope: this
        });
