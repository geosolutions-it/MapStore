...
public class TimeFormat extends BaseDescriptable {
     ...
     * https://github.com/geotools/geotools/blob/master/modules/plugin/imagemosaic/src/main/java
     * /org/geotools/gce/imagemosaic/properties/time/TimeParser.java?source=cc
     */
    static {
    ...
    /**
     * Parses date given in parameter according the ISO-8601 standard. This parameter should follow a syntax defined in the {@link #DEFAULT_PATTERNS}
    ...
    /**
     * Obtain Date from strings like '2014-01-30T08.25.11+01:00' or '2014-01-30T08:25:11+01:00' (uses XMLGregorianCalendar)
     * 
     * @param value
     * @return date
     */
    ...
    /**
     * Obtain minutes offset of the zone (need to be conbined with {@link TimeUtils#getHour(DateTimeZone)})
     * 
     * @param zone to obtain it
     * @return minutes offset
     */
