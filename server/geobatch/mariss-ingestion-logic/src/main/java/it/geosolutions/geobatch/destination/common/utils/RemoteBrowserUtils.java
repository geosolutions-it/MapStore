...
public class RemoteBrowserUtils {
     ...
     * @throws IOException
     */
    public static void deleteFile(RemoteBrowserProtocol protocol, String user, String password,
            String host, int port, int timeout, String filePath, String fileName,
            FTPConnectMode connectMode) throws FTPException, IOException {
        if (RemoteBrowserProtocol.ftp.equals(protocol)) {
            FTPHelperBare.deleteFileOrDirectory(host, fileName, false, cleanRoot(filePath), user,
                    password, port, connectMode, timeout);
        } else if (RemoteBrowserProtocol.sftp.equals(protocol)) {
            initFsManager(timeout);
            FileObject file = fsManager.resolveFile(
                    getURI(protocol, user, password, host, port, filePath + SEPARATOR + fileName),
                    fsOptions);
            file.delete();
        } else {
    ...
    public static List<String> ls(RemoteBrowserProtocol protocol, String userName, String password,
            String host, int port, String path, FTPConnectMode connectMode, int timeout,
            Pattern pattern) throws IOException, FTPException, ParseException {
    ...
    public static List<String> ls(RemoteBrowserProtocol protocol, String userName, String password,
            String host, int port, String path, FTPConnectMode connectMode, int timeout,
            Pattern pattern, Boolean foldersFlag) throws IOException, FTPException, ParseException {
     ...
     * @throws ParseException
     */
    private static List<String> sftpLS(String userName, String password, String host, int port,
            String path, int timeout, Pattern pattern, Boolean foldersFlag) throws IOException {
    ...
    private static boolean sftpmkdir(String serverUser, String serverPWD, String serverHost,
        ...
        return checkIfExists(RemoteBrowserProtocol.sftp, serverUser, serverHost, serverPWD,
