...
public abstract class DecompressUtils {
    ...
    protected final static Logger LOGGER = LoggerFactory.getLogger(DecompressUtils.class);

    /**
     * Decompress the compressed file in a folder checking and cleaning the target folder
     * 
     ...
     * @throws IOException
     */
    public static void untargz(String compressedFile, String outdir) throws IOException {
        ...
        try {
            ...
            e.printStackTrace();
            throw new IOException("Error decompressing " + compressedFile, e);
        } finally {
            if (tarIn != null) {
                tarIn.close();
            }
    ...
    /**
     * Unzip the file in a target folder. It fixes a bug for linux environments on {@link ZipUtil#unzip(String, String)} using the File.separator
     * instead "\\"
     * 
     * @param zipFilename
     * @param outdir
