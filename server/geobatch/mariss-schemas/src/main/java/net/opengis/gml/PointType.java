...
public class PointType extends AbstractGeometricPrimitiveType {
    ...
    /**
     * Deprecated with GML version 3.1.0 for coordinates with ordinate values that are numbers. Use "pos" instead. The "coordinates" element shall
     * only be used for coordinates with ordinates that require a string representation, e.g. DMS representations.
     * 
