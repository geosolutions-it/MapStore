...
/**
 * The spatiotemporal domain of a coverage. Typically * a geometry collection, * an implicit geometry (e.g. a grid), * an explicit or implicit
 * collection of time instances or periods, or
 * 
...
@XmlSeeAlso({ RectifiedGridDomainType.class, MultiCurveDomainType.class, GridDomainType.class,
        MultiSolidDomainType.class, MultiPointDomainType.class, MultiSurfaceDomainType.class })
