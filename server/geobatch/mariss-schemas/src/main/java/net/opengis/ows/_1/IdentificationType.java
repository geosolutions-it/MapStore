...
/**
 * Extended metadata identifying and describing a set of data. This type shall be extended if needed for each specific OWS to include additional
 * metadata for each type of dataset. If needed, this type should first be restricted for each specific OWS to change the multiplicity (or
 * optionality) of some elements.
 * 
 * <p>
...
public class IdentificationType extends BasicIdentificationType {
     ...
     * present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the availableCRS property.
     * 
     * <p>
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link JAXBElement }{@code <}{@link String }{@code >} {@link JAXBElement }{@code <}
     * {@link String }{@code >}
     * 
     * 
     */
