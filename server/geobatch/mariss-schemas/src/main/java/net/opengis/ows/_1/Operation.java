...
public class Operation {
    ...
    /**
     * Unordered list of Distributed Computing Platforms (DCPs) supported for this operation. At present, only the HTTP DCP is defined, so this
     * element will appear only once. Gets the value of the dcp property.
     * 
     * <p>
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list will be
     * present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the dcp property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * 
    ...
    /**
     * Optional unordered list of additional metadata about this operation and its' implementation. A list of required and optional metadata elements
     * for this operation should be specified in the Implementation Specification for this service. (Informative: This metadata might specify the
