...
/**
 * A LineString is a special curve that consists of a single segment with linear interpolation. It is defined by two or more coordinate tuples, with
 * linear interpolation between them. It is backwards compatible with the LineString of GML 2, GM_LineString of ISO 19107 is implemented by
 * LineStringSegment.
 * 
 * <p>
...
@XmlType(name = "LineStringType", propOrder = { "posOrPointPropertyOrPointRep", "posList",
        "coordinates" })
public class LineStringType extends AbstractCurveType {
     ...
     * {@code <}{@link CoordType }{@code >} {@link JAXBElement }{@code <}{@link DirectPositionType }{@code >} {@link JAXBElement }{@code <}
     * {@link PointPropertyType }{@code >}
     * 
     * 
     */
