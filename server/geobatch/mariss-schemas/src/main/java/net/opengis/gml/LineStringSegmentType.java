...
/**
 * A LineStringSegment is a curve segment that is defined by two or more coordinate tuples, with linear interpolation between them. Note:
...
@XmlType(name = "LineStringSegmentType", propOrder = { "posOrPointPropertyOrPointRep", "posList",
        "coordinates" })
