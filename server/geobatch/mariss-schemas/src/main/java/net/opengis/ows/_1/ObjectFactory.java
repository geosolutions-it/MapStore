...
/**
 * This object contains factory methods for each Java content interface and Java element interface generated in the net.opengis.ows._1 package.
 * <p>
...
public class ObjectFactory {
    ...
    private final static QName _Keywords_QNAME = new QName("http://www.opengis.net/ows/1.1",
            "Keywords");

    private final static QName _Manifest_QNAME = new QName("http://www.opengis.net/ows/1.1",
            "Manifest");

    private final static QName _AbstractReferenceBase_QNAME = new QName(
            "http://www.opengis.net/ows/1.1", "AbstractReferenceBase");

    private final static QName _OtherSource_QNAME = new QName("http://www.opengis.net/ows/1.1",
            "OtherSource");

    private final static QName _Fees_QNAME = new QName("http://www.opengis.net/ows/1.1", "Fees");

    private final static QName _InputData_QNAME = new QName("http://www.opengis.net/ows/1.1",
            "InputData");

    private final static QName _Reference_QNAME = new QName("http://www.opengis.net/ows/1.1",
            "Reference");

    private final static QName _SupportedCRS_QNAME = new QName("http://www.opengis.net/ows/1.1",
            "SupportedCRS");

    private final static QName _OutputFormat_QNAME = new QName("http://www.opengis.net/ows/1.1",
            "OutputFormat");

    private final static QName _OperationResponse_QNAME = new QName(
            "http://www.opengis.net/ows/1.1", "OperationResponse");

    private final static QName _ExtendedCapabilities_QNAME = new QName(
            "http://www.opengis.net/ows/1.1", "ExtendedCapabilities");
    ...
    private final static QName _ReferenceGroup_QNAME = new QName("http://www.opengis.net/ows/1.1",
            "ReferenceGroup");

    private final static QName _MinimumValue_QNAME = new QName("http://www.opengis.net/ows/1.1",
            "MinimumValue");

    private final static QName _BoundingBox_QNAME = new QName("http://www.opengis.net/ows/1.1",
            "BoundingBox");

    private final static QName _PositionName_QNAME = new QName("http://www.opengis.net/ows/1.1",
            "PositionName");

    private final static QName _Meaning_QNAME = new QName("http://www.opengis.net/ows/1.1",
            "Meaning");

    private final static QName _DefaultValue_QNAME = new QName("http://www.opengis.net/ows/1.1",
            "DefaultValue");

    private final static QName _Language_QNAME = new QName("http://www.opengis.net/ows/1.1",
            "Language");

    private final static QName _IndividualName_QNAME = new QName("http://www.opengis.net/ows/1.1",
            "IndividualName");

    private final static QName _Title_QNAME = new QName("http://www.opengis.net/ows/1.1", "Title");

    private final static QName _ReferenceSystem_QNAME = new QName("http://www.opengis.net/ows/1.1",
            "ReferenceSystem");

    private final static QName _AvailableCRS_QNAME = new QName("http://www.opengis.net/ows/1.1",
            "AvailableCRS");

    private final static QName _UOM_QNAME = new QName("http://www.opengis.net/ows/1.1", "UOM");

    private final static QName _Resource_QNAME = new QName("http://www.opengis.net/ows/1.1",
            "Resource");

    private final static QName _Exception_QNAME = new QName("http://www.opengis.net/ows/1.1",
            "Exception");

    private final static QName _ContactInfo_QNAME = new QName("http://www.opengis.net/ows/1.1",
            "ContactInfo");

    private final static QName _MaximumValue_QNAME = new QName("http://www.opengis.net/ows/1.1",
            "MaximumValue");

    private final static QName _Value_QNAME = new QName("http://www.opengis.net/ows/1.1", "Value");

    private final static QName _DatasetDescriptionSummary_QNAME = new QName(
            "http://www.opengis.net/ows/1.1", "DatasetDescriptionSummary");
    ...
    private final static QName _GetCapabilities_QNAME = new QName("http://www.opengis.net/ows/1.1",
            "GetCapabilities");

    private final static QName _AccessConstraints_QNAME = new QName(
            "http://www.opengis.net/ows/1.1", "AccessConstraints");
    ...
    public JAXBElement<LanguageStringType> createAbstract(LanguageStringType value) {
        return new JAXBElement<LanguageStringType>(_Abstract_QNAME, LanguageStringType.class, null,
                value);
    }
    ...
    public JAXBElement<AbstractReferenceBaseType> createAbstractReferenceBase(
            AbstractReferenceBaseType value) {
        return new JAXBElement<AbstractReferenceBaseType>(_AbstractReferenceBase_QNAME,
                AbstractReferenceBaseType.class, null, value);
    }
    ...
    public JAXBElement<BoundingBoxType> createBoundingBox(BoundingBoxType value) {
        return new JAXBElement<BoundingBoxType>(_BoundingBox_QNAME, BoundingBoxType.class, null,
                value);
    }
    ...
    public JAXBElement<DatasetDescriptionSummaryBaseType> createDatasetDescriptionSummary(
            DatasetDescriptionSummaryBaseType value) {
    ...
    public JAXBElement<DomainMetadataType> createDataType(DomainMetadataType value) {
        return new JAXBElement<DomainMetadataType>(_DataType_QNAME, DomainMetadataType.class, null,
                value);
    }
    ...
    public JAXBElement<GetResourceByIdType> createGetResourceByID(GetResourceByIdType value) {
        return new JAXBElement<GetResourceByIdType>(_GetResourceByID_QNAME,
                GetResourceByIdType.class, null, value);
    }
    ...
    public JAXBElement<RequestMethodType> createHTTPGet(RequestMethodType value) {
        return new JAXBElement<RequestMethodType>(_HTTPGet_QNAME, RequestMethodType.class,
                HTTP.class, value);
    }
    ...
    public JAXBElement<RequestMethodType> createHTTPPost(RequestMethodType value) {
        return new JAXBElement<RequestMethodType>(_HTTPPost_QNAME, RequestMethodType.class,
                HTTP.class, value);
    }
    ...
    public JAXBElement<DomainMetadataType> createMeaning(DomainMetadataType value) {
        return new JAXBElement<DomainMetadataType>(_Meaning_QNAME, DomainMetadataType.class, null,
                value);
    }
    ...
    public JAXBElement<ManifestType> createOperationResponse(ManifestType value) {
        return new JAXBElement<ManifestType>(_OperationResponse_QNAME, ManifestType.class, null,
                value);
    }
    ...
    public JAXBElement<ReferenceGroupType> createReferenceGroup(ReferenceGroupType value) {
        return new JAXBElement<ReferenceGroupType>(_ReferenceGroup_QNAME, ReferenceGroupType.class,
                null, value);
    }
    ...
    public JAXBElement<ServiceReferenceType> createServiceReference(ServiceReferenceType value) {
        return new JAXBElement<ServiceReferenceType>(_ServiceReference_QNAME,
                ServiceReferenceType.class, null, value);
    }
    ...
    public JAXBElement<LanguageStringType> createTitle(LanguageStringType value) {
        return new JAXBElement<LanguageStringType>(_Title_QNAME, LanguageStringType.class, null,
                value);
    }
    ...
    public JAXBElement<DomainMetadataType> createUOM(DomainMetadataType value) {
        return new JAXBElement<DomainMetadataType>(_UOM_QNAME, DomainMetadataType.class, null,
                value);
    }
