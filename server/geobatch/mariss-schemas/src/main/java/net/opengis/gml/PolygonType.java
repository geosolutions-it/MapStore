...
/**
 * A Polygon is a special surface that is defined by a single surface patch. The boundary of this patch is coplanar and the polygon uses planar
 * interpolation in its interior. It is backwards compatible with the Polygon of GML 2, GM_Polygon of ISO 19107 is implemented by PolygonPatch.
 * 
 * <p>
...
public class PolygonType extends AbstractSurfaceType {
     ...
     * 
     * @return possible object is {@link JAXBElement }{@code <}{@link AbstractRingPropertyType }{@code >} {@link JAXBElement }{@code <}
     *         {@link AbstractRingPropertyType }{@code >}
     * 
     */
     ...
     * present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the interior property.
     * 
     * <p>
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link JAXBElement }{@code <}{@link AbstractRingPropertyType }{@code >}
     ...
     * 
     * @param value allowed object is {@link JAXBElement }{@code <}{@link AbstractRingPropertyType }{@code >} {@link JAXBElement }{@code <}
     *        {@link AbstractRingPropertyType }{@code >}
     * 
     */
