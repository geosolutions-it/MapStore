...
/**
 * A calendar is a discrete temporal reference system that provides a basis for defining temporal position to a resolution of one day. A single
 * calendar may reference more than one calendar era.
 * 
 * <p>
...
public class TimeCalendarType extends AbstractTimeReferenceSystemType {
     ...
     * present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the referenceFrame property.
     * 
     * <p>
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link TimeCalendarEraPropertyType }
     * 
     * 
     */
