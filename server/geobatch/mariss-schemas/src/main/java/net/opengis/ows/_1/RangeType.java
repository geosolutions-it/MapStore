...
/**
 * A range of values of a numeric parameter. This range can be continuous or discrete, defined by a fixed spacing between adjacent valid values. If
 * the MinimumValue or MaximumValue is not included, there is no value limit in that direction. Inclusion of the specified minimum and maximum values
 * in the range shall be defined by the rangeClosure.
 * 
 * <p>
...
public class RangeType {
     ...
     * present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the rangeClosure property.
     * 
     * <p>
    ...
    /**
     * Shall be included when the allowed values are NOT continuous in this range. Shall not be included when the allowed values are continuous in
     * this range.
     * 
     * @return possible object is {@link ValueType }
     * 
