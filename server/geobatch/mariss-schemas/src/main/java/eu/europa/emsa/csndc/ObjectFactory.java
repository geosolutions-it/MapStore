 ...
 * generated in the eu.europa.emsa.csndc package. 
...
public class ObjectFactory {
    ...
    private final static QName _Identifier_QNAME = new QName("http://www.emsa.europa.eu/csndc", "identifier");
    private final static QName _ProcessRequest_QNAME = new QName("http://www.emsa.europa.eu/csndc", "processRequest");
    private final static QName _DetectedShipReference_QNAME = new QName("http://www.emsa.europa.eu/csndc", "detectedShipReference");
    private final static QName _DetectedShips_QNAME = new QName("http://www.emsa.europa.eu/csndc", "detectedShips");
    private final static QName _Ship_QNAME = new QName("http://www.emsa.europa.eu/csndc", "Ship");
    private final static QName _QualityReport_QNAME = new QName("http://www.emsa.europa.eu/csndc", "qualityReport");
    private final static QName _SarDerivedData_QNAME = new QName("http://www.emsa.europa.eu/csndc", "sarDerivedData");
    private final static QName _FileName_QNAME = new QName("http://www.emsa.europa.eu/csndc", "fileName");
    private final static QName _PackageInfo_QNAME = new QName("http://www.emsa.europa.eu/csndc", "packageInfo");
    private final static QName _OilSpill_QNAME = new QName("http://www.emsa.europa.eu/csndc", "OilSpill");
    private final static QName _QualityNotification_QNAME = new QName("http://www.emsa.europa.eu/csndc", "qualityNotification");
    private final static QName _SarDerivedDataReference_QNAME = new QName("http://www.emsa.europa.eu/csndc", "sarDerivedDataReference");
    private final static QName _OilSpillReference_QNAME = new QName("http://www.emsa.europa.eu/csndc", "oilSpillReference");
    private final static QName _DataPackage_QNAME = new QName("http://www.emsa.europa.eu/csndc", "dataPackage");
    private final static QName _OilSpills_QNAME = new QName("http://www.emsa.europa.eu/csndc", "oilSpills");
    private final static QName _EoProduct_QNAME = new QName("http://www.emsa.europa.eu/csndc", "eoProduct");
    private final static QName _ShipTypeHeading_QNAME = new QName("http://www.emsa.europa.eu/csndc", "heading");
    private final static QName _ShipTypePositionAccuracyVector_QNAME = new QName("http://www.emsa.europa.eu/csndc", "positionAccuracyVector");
    private final static QName _ShipTypeShipThumbnail_QNAME = new QName("http://www.emsa.europa.eu/csndc", "shipThumbnail");
    private final static QName _ShipTypeConfidenceLevel_QNAME = new QName("http://www.emsa.europa.eu/csndc", "confidenceLevel");
    private final static QName _ShipTypeLength_QNAME = new QName("http://www.emsa.europa.eu/csndc", "length");
    private final static QName _ShipTypeId_QNAME = new QName("http://www.emsa.europa.eu/csndc", "id");
    private final static QName _ShipTypeIncludeInReport_QNAME = new QName("http://www.emsa.europa.eu/csndc", "includeInReport");
    private final static QName _ShipTypeWidthError_QNAME = new QName("http://www.emsa.europa.eu/csndc", "widthError");
    private final static QName _ShipTypeLengthError_QNAME = new QName("http://www.emsa.europa.eu/csndc", "lengthError");
    private final static QName _ShipTypeDetectionParameters_QNAME = new QName("http://www.emsa.europa.eu/csndc", "detectionParameters");
    private final static QName _ShipTypeWidth_QNAME = new QName("http://www.emsa.europa.eu/csndc", "width");
    private final static QName _ShipTypeSpeed_QNAME = new QName("http://www.emsa.europa.eu/csndc", "speed");
    private final static QName _ShipTypeTimeStamp_QNAME = new QName("http://www.emsa.europa.eu/csndc", "timeStamp");
    private final static QName _ShipTypeImageIdentifier_QNAME = new QName("http://www.emsa.europa.eu/csndc", "imageIdentifier");
    private final static QName _LocationClassificationTypeCountry_QNAME = new QName("http://www.emsa.europa.eu/csndc", "country");
    ...
    public JAXBElement<ProcessRequestType> createProcessRequest(ProcessRequestType value) {
        return new JAXBElement<ProcessRequestType>(_ProcessRequest_QNAME, ProcessRequestType.class, null, value);
    }
    ...
    public JAXBElement<DetectedShipReferenceType> createDetectedShipReference(DetectedShipReferenceType value) {
        return new JAXBElement<DetectedShipReferenceType>(_DetectedShipReference_QNAME, DetectedShipReferenceType.class, null, value);
    }
    ...
    public JAXBElement<DetectedShipsType> createDetectedShips(DetectedShipsType value) {
        return new JAXBElement<DetectedShipsType>(_DetectedShips_QNAME, DetectedShipsType.class, null, value);
    }
    ...
    public JAXBElement<SARDerivedDataType> createSarDerivedData(SARDerivedDataType value) {
        return new JAXBElement<SARDerivedDataType>(_SarDerivedData_QNAME, SARDerivedDataType.class, null, value);
    }
    ...
    public JAXBElement<PackageInfoType> createPackageInfo(PackageInfoType value) {
        return new JAXBElement<PackageInfoType>(_PackageInfo_QNAME, PackageInfoType.class, null, value);
    }
    ...
    public JAXBElement<QualityType> createQualityNotification(QualityType value) {
        return new JAXBElement<QualityType>(_QualityNotification_QNAME, QualityType.class, null, value);
    }
    ...
    public JAXBElement<SARDerivedDataReferenceType> createSarDerivedDataReference(SARDerivedDataReferenceType value) {
        return new JAXBElement<SARDerivedDataReferenceType>(_SarDerivedDataReference_QNAME, SARDerivedDataReferenceType.class, null, value);
    }
    ...
    public JAXBElement<OilSpillReferenceType> createOilSpillReference(OilSpillReferenceType value) {
        return new JAXBElement<OilSpillReferenceType>(_OilSpillReference_QNAME, OilSpillReferenceType.class, null, value);
    }
    ...
    public JAXBElement<DataPackageType> createDataPackage(DataPackageType value) {
        return new JAXBElement<DataPackageType>(_DataPackage_QNAME, DataPackageType.class, null, value);
    }
    ...
    public JAXBElement<BigInteger> createShipTypeHeading(BigInteger value) {
        return new JAXBElement<BigInteger>(_ShipTypeHeading_QNAME, BigInteger.class, ShipType.class, value);
    }
    ...
    public JAXBElement<PositionAccuracyVectorType> createShipTypePositionAccuracyVector(PositionAccuracyVectorType value) {
        return new JAXBElement<PositionAccuracyVectorType>(_ShipTypePositionAccuracyVector_QNAME, PositionAccuracyVectorType.class, ShipType.class, value);
    }
    ...
    public JAXBElement<String> createShipTypeShipThumbnail(String value) {
        return new JAXBElement<String>(_ShipTypeShipThumbnail_QNAME, String.class, ShipType.class, value);
    }
    ...
    public JAXBElement<Double> createShipTypeConfidenceLevel(Double value) {
        return new JAXBElement<Double>(_ShipTypeConfidenceLevel_QNAME, Double.class, ShipType.class, value);
    }
    ...
    public JAXBElement<Boolean> createShipTypeIncludeInReport(Boolean value) {
        return new JAXBElement<Boolean>(_ShipTypeIncludeInReport_QNAME, Boolean.class, ShipType.class, value);
    }
    ...
    public JAXBElement<Double> createShipTypeWidthError(Double value) {
        return new JAXBElement<Double>(_ShipTypeWidthError_QNAME, Double.class, ShipType.class, value);
    }
    ...
    public JAXBElement<Double> createShipTypeLengthError(Double value) {
        return new JAXBElement<Double>(_ShipTypeLengthError_QNAME, Double.class, ShipType.class, value);
    }
    ...
    public JAXBElement<DetectionParametersType> createShipTypeDetectionParameters(DetectionParametersType value) {
        return new JAXBElement<DetectionParametersType>(_ShipTypeDetectionParameters_QNAME, DetectionParametersType.class, ShipType.class, value);
    }
    ...
    public JAXBElement<XMLGregorianCalendar> createShipTypeTimeStamp(XMLGregorianCalendar value) {
        return new JAXBElement<XMLGregorianCalendar>(_ShipTypeTimeStamp_QNAME, XMLGregorianCalendar.class, ShipType.class, value);
    }
    ...
    public JAXBElement<ImageType> createShipTypeImageIdentifier(ImageType value) {
        return new JAXBElement<ImageType>(_ShipTypeImageIdentifier_QNAME, ImageType.class, ShipType.class, value);
    }
    ...
    public JAXBElement<String> createLocationClassificationTypeCountry(String value) {
        return new JAXBElement<String>(_LocationClassificationTypeCountry_QNAME, String.class, LocationClassificationType.class, value);
    }
