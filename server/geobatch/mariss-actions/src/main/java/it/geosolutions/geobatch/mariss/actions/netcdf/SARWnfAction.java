        ...
        try {
            ...
            if (numVariables > 0) {
                ...
                for (String varName : attributeBean.foundVariables.keySet()) {
                    ...
                    // writing bin data ...
                    try {
                        writingDataSets(varName, ra_size, az_size, lonOriginalData, latOriginalData,
                                attributeBean.timedim, hasTime, noData, latDataType, lonDataType,
                                attributeBean.env, ncFileIn, writable, attributeBean);
