...
/**
 * Configuration For <ActionWrapper> Action Provides base functionalities to wrap many action dispatching events to the sub-actions.
 * 
 * Stores the output events of each sub action and allows to forward theese to other sub-actions.
 * 
