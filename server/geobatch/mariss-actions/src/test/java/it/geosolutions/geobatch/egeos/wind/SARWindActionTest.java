...
public class SARWindActionTest extends BaseNetCDFActionTest {
    ...
    protected final static Logger LOGGER = LoggerFactory.getLogger(SARWindActionTest.class);
    ...
    public void sarWindTest() throws Exception {
        try {
            // configure
            SARWindActionConfiguration configuration = new SARWindActionConfiguration(null, null,
                    null);
